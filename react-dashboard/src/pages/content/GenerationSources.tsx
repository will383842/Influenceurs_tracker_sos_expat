...
const SOURCES: SourceDef[] = [
  ...
  },
  {
    slug: 'part-avocats',
    label: 'Part Avocats',
    description: "Contenus fournis ou inspirés par les prestataires avocats inscrits. Expertise juridique.",
    icon: '🏛️',
  ...
  },
  {
    slug: 'part-expat',
    label: 'Part Expat',
    description: "Contenus fournis par les prestataires expat inscrits. Angle vécu, conseils pratiques.",
    icon: '✈️',
