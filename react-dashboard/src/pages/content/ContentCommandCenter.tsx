...
const SOURCE_DEFS = [
  ...
  { slug: 'art-mots-cles',    label: 'Art Mots Clés',    icon: '🔑', accent: 'text-violet-light', contentType: 'article',       blogCategory: '/fiches-pratiques',   inputQuality: 'title_only'  as const,  defaultWeight: 10 },
  { slug: 'longues-traines',  label: 'Longues Traînes',  icon: '📐', accent: 'text-lime-400',     contentType: 'article',       blogCategory: '/fiches-thematiques', inputQuality: 'title_only'  as const,  defaultWeight: 10 },
  { slug: 'brand-content',    label: 'Brand Content',    icon: '🏷️', accent: 'text-amber-400',    contentType: 'article',       blogCategory: '/programme',          inputQuality: 'title_only'  as const,  defaultWeight: 5  },
