...
class GenerationSourceCategoriesSeeder extends Seeder
{
    public function run(): void
    {
        $categories = [
            ...
            ['slug' => 'chatters',                'name' => 'Chatters',                'icon' => '💬', 'description' => 'Affiliation chatters par pays'],
            ['slug' => 'bloggeurs',               'name' => 'Influenceurs',            'icon' => '📢', 'description' => 'Affiliation influenceurs/blogueurs'],
            ['slug' => 'admin-groups',            'name' => 'Admin Groupes',           'icon' => '👥', 'description' => 'Affiliation admins groupes'],
            ['slug' => 'avocats',                 'name' => 'Partenaires Avocats',     'icon' => '⚖️', 'description' => 'Partenariat avocats prestataires'],
            ['slug' => 'expats-aidants',          'name' => 'Partenaires Expats',      'icon' => '🧳', 'description' => 'Partenariat expatries aidants'],
