...
class CountryCampaignCommand extends Command
{
    ...
    private const TOP_CITIES = [
        ...
        // ══════════════════════════════════════════════════════════════════
        // REMAINING 99 COUNTRIES — smaller hubs and less common destinations
        // ══════════════════════════════════════════════════════════════════

        // ── EUROPE (remaining) ──
        'AL' => ['Tirana', 'Durres', 'Vlore', 'Shkoder', 'Sarande', 'Gjirokaster'],
        'AD' => ['Andorre-la-Vieille', 'Encamp', 'La Massana', 'Les Escaldes', 'Ordino', 'Sant Julia de Loria'],
        'BY' => ['Minsk', 'Brest', 'Gomel', 'Moguilev', 'Grodno', 'Vitebsk'],
        'BA' => ['Sarajevo', 'Banja Luka', 'Mostar', 'Tuzla', 'Zenica', 'Bihac'],
        'XK' => ['Pristina', 'Prizren', 'Peje', 'Gjakova', 'Mitrovica', 'Ferizaj'],
        'LI' => ['Vaduz', 'Schaan', 'Balzers', 'Triesen', 'Eschen', 'Mauren'],
        'MD' => ['Chisinau', 'Balti', 'Tiraspol', 'Cahul', 'Ungheni', 'Orhei'],
        'MC' => ['Monaco-Ville', 'Monte-Carlo', 'La Condamine', 'Fontvieille', 'Larvotto', 'Moneghetti'],
        'ME' => ['Podgorica', 'Niksic', 'Pljevlja', 'Bijelo Polje', 'Cetinje', 'Budva'],
        'MK' => ['Skopje', 'Bitola', 'Kumanovo', 'Prilep', 'Tetovo', 'Veles'],
        'SM' => ['Saint-Marin', 'Borgo Maggiore', 'Serravalle', 'Domagnano', 'Fiorentino', 'Acquaviva'],
        'RS' => ['Belgrade', 'Novi Sad', 'Nis', 'Kragujevac', 'Subotica', 'Zemun'],
        'VA' => ['Vatican', 'Place Saint-Pierre', 'Castel Gandolfo', 'Chapelle Sixtine', 'Musees du Vatican', 'Jardins du Vatican'],

        // ── ASIE (remaining) ──
        'AF' => ['Kaboul', 'Herat', 'Kandahar', 'Mazar-i-Sharif', 'Jalalabad', 'Kunduz'],
        'AM' => ['Erevan', 'Gyumri', 'Vanadzor', 'Vagharshapat', 'Abovian', 'Kapan'],
        'AZ' => ['Bakou', 'Gandja', 'Soumgait', 'Mingachevir', 'Qabala', 'Lankaran'],
        'BT' => ['Thimphou', 'Paro', 'Punakha', 'Phuentsholing', 'Jakar', 'Trongsa'],
        'BN' => ['Bandar Seri Begawan', 'Kuala Belait', 'Seria', 'Tutong', 'Bangar', 'Muara'],
        'GE' => ['Tbilissi', 'Batoumi', 'Koutaissi', 'Roustavi', 'Mestia', 'Gori'],
        'IR' => ['Teheran', 'Ispahan', 'Chiraz', 'Machhad', 'Tabriz', 'Qom'],
        'IQ' => ['Bagdad', 'Bassora', 'Erbil', 'Mossoul', 'Kerbala', 'Nadjaf'],
        'KZ' => ['Astana', 'Almaty', 'Chimkent', 'Karaganda', 'Aktobe', 'Taraz'],
        'KP' => ['Pyongyang', 'Hamhung', 'Chongjin', 'Nampo', 'Wonsan', 'Sinuiju'],
        'KG' => ['Bichkek', 'Och', 'Djalal-Abad', 'Tokmok', 'Karakol', 'Balychky'],
        'MO' => ['Macao', 'Taipa', 'Coloane', 'Cotai', 'Sao Lourenco', 'Se'],
        'MV' => ['Male', 'Hulhumale', 'Addu', 'Fuvahmulah', 'Kulhudhuffushi', 'Thinadhoo'],
        'MN' => ['Oulan-Bator', 'Erdenet', 'Darkhan', 'Choibalsan', 'Moron', 'Kharkhorin'],
        'PS' => ['Ramallah', 'Gaza', 'Hebron', 'Naplouse', 'Bethleem', 'Jenine'],
        'SY' => ['Damas', 'Alep', 'Homs', 'Lattaquie', 'Hama', 'Deir ez-Zor'],
        'TJ' => ['Douchanbe', 'Khujand', 'Kulyab', 'Bokhtar', 'Istravshan', 'Khorog'],
        'TL' => ['Dili', 'Baucau', 'Maliana', 'Ermera', 'Lospalos', 'Same'],
        'TM' => ['Achgabat', 'Turkmenabat', 'Dasoguz', 'Mary', 'Balkanabat', 'Turkmenbasi'],
        'UZ' => ['Tachkent', 'Samarcande', 'Boukhara', 'Namangan', 'Andijan', 'Khiva'],
        'YE' => ['Sanaa', 'Aden', 'Taez', 'Al Hudaydah', 'Ibb', 'Mukalla'],

        // ── AMERIQUES (remaining) ──
        'AG' => ['Saint John', 'English Harbour', 'Jolly Harbour', 'All Saints', 'Liberta', 'Parham'],
        'BS' => ['Nassau', 'Freeport', 'Paradise Island', 'Bimini', 'Eleuthera', 'Exuma'],
        'BB' => ['Bridgetown', 'Holetown', 'Oistins', 'Speightstown', 'Bathsheba', 'Worthing'],
        'BZ' => ['Belize City', 'San Pedro', 'Caye Caulker', 'Placencia', 'Hopkins', 'San Ignacio'],
        'DM' => ['Roseau', 'Portsmouth', 'Marigot', 'Castle Bruce', 'Grand Bay', 'Soufriere'],
        'GD' => ['Saint George', 'Grenville', 'Gouyave', 'Victoria', 'Sauteurs', 'Carriacou'],
        'GY' => ['Georgetown', 'Linden', 'New Amsterdam', 'Essequibo', 'Lethem', 'Bartica'],
        'HT' => ['Port-au-Prince', 'Cap-Haitien', 'Jacmel', 'Les Cayes', 'Gonaives', 'Port-de-Paix'],
        'HN' => ['Tegucigalpa', 'San Pedro Sula', 'La Ceiba', 'Roatan', 'Utila', 'Copan'],
        'SV' => ['San Salvador', 'Santa Ana', 'San Miguel', 'Sonsonate', 'La Libertad', 'El Tunco'],
        'KN' => ['Basseterre', 'Charlestown', 'Sandy Point', 'Dieppe Bay', 'Old Road', 'Newton Ground'],
        'LC' => ['Castries', 'Soufriere', 'Vieux Fort', 'Gros Islet', 'Rodney Bay', 'Marigot Bay'],
        'VC' => ['Kingstown', 'Bequia', 'Mustique', 'Union Island', 'Canouan', 'Mayreau'],
        'SR' => ['Paramaribo', 'Lelydorp', 'Nieuw Nickerie', 'Moengo', 'Brokopondo', 'Albina'],
        'TT' => ['Port-d\'Espagne', 'San Fernando', 'Chaguanas', 'Arima', 'Scarborough', 'Crown Point'],
        'VE' => ['Caracas', 'Maracaibo', 'Valencia', 'Maracay', 'Barquisimeto', 'Merida'],

        // ── AFRIQUE (remaining) ──
        'AO' => ['Luanda', 'Huambo', 'Benguela', 'Lobito', 'Lubango', 'Namibe'],
        'BJ' => ['Porto-Novo', 'Cotonou', 'Parakou', 'Djougou', 'Abomey', 'Natitingou'],
        'BW' => ['Gaborone', 'Francistown', 'Molepolole', 'Maun', 'Kasane', 'Serowe'],
        'BF' => ['Ouagadougou', 'Bobo-Dioulasso', 'Koudougou', 'Ouahigouya', 'Banfora', 'Kaya'],
        'BI' => ['Gitega', 'Bujumbura', 'Muyinga', 'Ruyigi', 'Ngozi', 'Rumonge'],
        'CV' => ['Praia', 'Mindelo', 'Santa Maria', 'Tarrafal', 'Assomada', 'Espargos'],
        'CF' => ['Bangui', 'Bimbo', 'Berberati', 'Carnot', 'Bambari', 'Bouar'],
        'TD' => ['N\'Djamena', 'Moundou', 'Sarh', 'Abeche', 'Kelo', 'Koumra'],
        'KM' => ['Moroni', 'Moutsamoudou', 'Fomboni', 'Domoni', 'Tsembehou', 'Ouani'],
        'CD' => ['Kinshasa', 'Lubumbashi', 'Mbuji-Mayi', 'Kisangani', 'Bukavu', 'Goma'],
        'CG' => ['Brazzaville', 'Pointe-Noire', 'Dolisie', 'Nkayi', 'Owando', 'Ouesso'],
        'DJ' => ['Djibouti-Ville', 'Ali Sabieh', 'Dikhil', 'Tadjoura', 'Obock', 'Arta'],
        'GQ' => ['Malabo', 'Bata', 'Ebebiyin', 'Luba', 'Evinayong', 'Mongomo'],
        'ER' => ['Asmara', 'Keren', 'Massawa', 'Assab', 'Mendefera', 'Barentu'],
        'SZ' => ['Mbabane', 'Manzini', 'Lobamba', 'Nhlangano', 'Siteki', 'Piggs Peak'],
        'GA' => ['Libreville', 'Port-Gentil', 'Franceville', 'Oyem', 'Lambarene', 'Mouila'],
        'GM' => ['Banjul', 'Serekunda', 'Brikama', 'Bakau', 'Farafenni', 'Basse'],
        'GN' => ['Conakry', 'Kankan', 'Nzerekore', 'Labe', 'Kindia', 'Mamou'],
        'GW' => ['Bissau', 'Bafata', 'Gabu', 'Canchungo', 'Bissora', 'Catio'],
        'LS' => ['Maseru', 'Teyateyaneng', 'Mafeteng', 'Hlotse', 'Mohale\'s Hoek', 'Qacha\'s Nek'],
        'LR' => ['Monrovia', 'Gbarnga', 'Kakata', 'Harper', 'Ganta', 'Buchanan'],
        'LY' => ['Tripoli', 'Benghazi', 'Misrata', 'Tobrouk', 'Sirte', 'Sabha'],
        'MW' => ['Lilongwe', 'Blantyre', 'Mzuzu', 'Zomba', 'Kasungu', 'Mangochi'],
        'ML' => ['Bamako', 'Sikasso', 'Mopti', 'Segou', 'Kayes', 'Koutiala'],
        'MR' => ['Nouakchott', 'Nouadhibou', 'Kiffa', 'Rosso', 'Kaedi', 'Atar'],
        'MZ' => ['Maputo', 'Beira', 'Nampula', 'Quelimane', 'Tete', 'Pemba'],
        'NA' => ['Windhoek', 'Walvis Bay', 'Swakopmund', 'Oshakati', 'Rundu', 'Luderitz'],
        'NE' => ['Niamey', 'Zinder', 'Maradi', 'Tahoua', 'Agadez', 'Arlit'],
        'SC' => ['Victoria', 'Beau Vallon', 'Praslin', 'La Digue', 'Anse Royale', 'Bel Ombre'],
        'SL' => ['Freetown', 'Bo', 'Kenema', 'Makeni', 'Koidu', 'Port Loko'],
        'SO' => ['Mogadiscio', 'Hargeisa', 'Kismayo', 'Baidoa', 'Garoowe', 'Burao'],
        'SS' => ['Juba', 'Malakal', 'Wau', 'Yei', 'Bor', 'Bentiu'],
        'SD' => ['Khartoum', 'Omdourman', 'Port-Soudan', 'Kassala', 'Nyala', 'Wad Madani'],
        'ST' => ['Sao Tome', 'Neves', 'Santana', 'Trindade', 'Santo Amaro', 'Guadalupe'],
        'TG' => ['Lome', 'Sokode', 'Kara', 'Palime', 'Atakpame', 'Bassar'],
        'UG' => ['Kampala', 'Gulu', 'Lira', 'Mbale', 'Mbarara', 'Jinja'],
        'ZM' => ['Lusaka', 'Kitwe', 'Ndola', 'Livingstone', 'Kabwe', 'Chingola'],
        'ZW' => ['Harare', 'Bulawayo', 'Chitungwiza', 'Mutare', 'Gweru', 'Victoria Falls'],

        // ── OCEANIE (remaining) ──
        'KI' => ['Tarawa', 'Betio', 'Bairiki', 'Bikenibeu', 'Butaritari', 'Kiritimati'],
        'MH' => ['Majuro', 'Ebeye', 'Delap-Uliga-Darrit', 'Kwajalein', 'Jabor', 'Rita'],
        'FM' => ['Palikir', 'Weno', 'Kolonia', 'Tofol', 'Lelu', 'Colonia'],
        'NR' => ['Yaren', 'Baiti', 'Anabar', 'Ewa', 'Buada', 'Meneng'],
        'PW' => ['Ngerulmud', 'Koror', 'Melekeok', 'Airai', 'Ngchesar', 'Ngiwal'],
        'PG' => ['Port Moresby', 'Lae', 'Mount Hagen', 'Madang', 'Wewak', 'Goroka'],
        'WS' => ['Apia', 'Vaitele', 'Afega', 'Savai\'i', 'Saleimoa', 'Leulumoega'],
        'SB' => ['Honiara', 'Auki', 'Gizo', 'Munda', 'Buala', 'Tulagi'],
        'TO' => ['Nuku\'alofa', 'Neiafu', 'Ha\'apai', 'Eua', 'Vava\'u', 'Niuatoputapu'],
        'TV' => ['Funafuti', 'Savave', 'Tumaseu', 'Asau', 'Kulia', 'Tanrake'],
        'VU' => ['Port-Vila', 'Luganville', 'Lakatoro', 'Norsup', 'Sola', 'Lenakel'],
    ];
