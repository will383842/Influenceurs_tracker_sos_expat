...
class CountryCampaignCommand extends Command
{
    ...
    private const TOP_CITIES = [
        ...
        'SG' => ['Singapour Centre', 'Orchard', 'Marina Bay', 'Sentosa', 'Tiong Bahru', 'Tanjong Pagar', 'Little India', 'Chinatown', 'Jurong East', 'Punggol'],
        'PT' => ['Lisbonne', 'Porto', 'Algarve', 'Madere', 'Cascais', 'Coimbra', 'Setubal', 'Evora', 'Braga', 'Aveiro'],
        'ES' => ['Barcelone', 'Madrid', 'Valence', 'Malaga', 'Seville', 'Palma de Majorque', 'Bilbao', 'San Sebastian', 'Grenade', 'Ibiza'],
        'ID' => ['Bali', 'Jakarta', 'Yogyakarta', 'Ubud', 'Canggu', 'Bandung', 'Surabaya', 'Lombok', 'Medan', 'Makassar'],
        'MX' => ['Mexico', 'Playa del Carmen', 'Guadalajara', 'Tulum', 'Merida', 'Oaxaca', 'San Cristobal de las Casas', 'Puerto Vallarta', 'Monterrey', 'Puebla'],
        'MA' => ['Casablanca', 'Marrakech', 'Rabat', 'Tanger', 'Agadir', 'Essaouira', 'Fes', 'Meknes', 'Chefchaouen', 'El Jadida'],
        'AE' => ['Dubai', 'Abu Dhabi', 'Sharjah', 'Al Ain', 'Ras Al Khaimah', 'Ajman', 'Fujairah', 'Umm Al Quwain', 'Khalifa City', 'Al Reem Island'],
        'JP' => ['Tokyo', 'Osaka', 'Kyoto', 'Fukuoka', 'Yokohama', 'Sapporo', 'Hiroshima', 'Naha', 'Kobe', 'Nagoya'],
        'DE' => ['Berlin', 'Munich', 'Francfort', 'Hambourg', 'Cologne', 'Stuttgart', 'Dusseldorf', 'Leipzig', 'Nuremberg', 'Dresde'],
        'GB' => ['Londres', 'Manchester', 'Edimbourg', 'Bristol', 'Birmingham', 'Glasgow', 'Leeds', 'Liverpool', 'Cardiff', 'Newcastle'],
        'CA' => ['Montreal', 'Toronto', 'Vancouver', 'Calgary', 'Ottawa', 'Quebec', 'Edmonton', 'Winnipeg', 'Halifax', 'Victoria'],
        'AU' => ['Sydney', 'Melbourne', 'Brisbane', 'Perth', 'Adelaide', 'Gold Coast', 'Cairns', 'Byron Bay', 'Canberra', 'Darwin'],
        'BR' => ['Sao Paulo', 'Rio de Janeiro', 'Florianopolis', 'Curitiba', 'Salvador', 'Belo Horizonte', 'Recife', 'Manaus', 'Fortaleza', 'Porto Alegre'],
        'CO' => ['Medellin', 'Bogota', 'Cartagena', 'Cali', 'Santa Marta', 'Barranquilla', 'Pereira', 'Manizales', 'Villa de Leyva', 'Leticia'],
        'CR' => ['San Jose', 'Tamarindo', 'Puerto Viejo', 'Manuel Antonio', 'Monteverde', 'Jaco', 'Santa Teresa', 'Nosara', 'La Fortuna', 'Drake Bay'],
        'GR' => ['Athenes', 'Thessalonique', 'Crete', 'Mykonos', 'Santorin', 'Corfou', 'Rhodes', 'Naxos', 'Paros', 'Hydra'],
        'HR' => ['Zagreb', 'Split', 'Dubrovnik', 'Rijeka', 'Pula', 'Zadar', 'Rovinj', 'Sibenik', 'Hvar', 'Trogir'],
        'IT' => ['Rome', 'Milan', 'Florence', 'Naples', 'Bologne', 'Turin', 'Venise', 'Bari', 'Palerme', 'Verone'],
        'NL' => ['Amsterdam', 'Rotterdam', 'La Haye', 'Utrecht', 'Eindhoven', 'Groningue', 'Maastricht', 'Tilburg', 'Alkmaar', 'Delft'],
        'BE' => ['Bruxelles', 'Anvers', 'Gand', 'Bruges', 'Liege', 'Louvain', 'Namur', 'Mons', 'Hasselt', 'Mechelen'],
        'CH' => ['Geneve', 'Zurich', 'Lausanne', 'Bale', 'Berne', 'Lugano', 'Interlaken', 'Lucerne', 'Locarno', 'Montreux'],
        'TR' => ['Istanbul', 'Antalya', 'Izmir', 'Ankara', 'Bodrum', 'Fethiye', 'Alanya', 'Marmaris', 'Kas', 'Trabzon'],
        'PH' => ['Manille', 'Cebu', 'Davao', 'Boracay', 'Siargao', 'Palawan', 'Iloilo', 'Bohol', 'General Santos', 'Cagayan de Oro'],
        'MY' => ['Kuala Lumpur', 'Penang', 'Johor Bahru', 'Kota Kinabalu', 'Langkawi', 'Malacca', 'Ipoh', 'Kuching', 'Miri', 'Putrajaya'],
        'KH' => ['Phnom Penh', 'Siem Reap', 'Sihanoukville', 'Battambang', 'Kep', 'Kampot', 'Kratie', 'Mondulkiri', 'Ratanakiri', 'Koh Kong'],
        'IN' => ['Mumbai', 'Bangalore', 'Goa', 'New Delhi', 'Pondichery', 'Pune', 'Jaipur', 'Kolkata', 'Hyderabad', 'Chennai'],
        'PL' => ['Varsovie', 'Cracovie', 'Wroclaw', 'Gdansk', 'Poznan', 'Lodz', 'Katowice', 'Torun', 'Lublin', 'Bialystok'],

        // ── EUROPE (additional hubs) ──
        'FR' => ['Paris', 'Lyon', 'Marseille', 'Bordeaux', 'Nice', 'Toulouse', 'Nantes', 'Strasbourg', 'Montpellier', 'Rennes'],
        'AT' => ['Vienne', 'Salzbourg', 'Innsbruck', 'Graz', 'Linz', 'Klagenfurt', 'Bregenz', 'Baden bei Wien', 'Wiener Neustadt', 'Eisenstadt'],
        'IE' => ['Dublin', 'Cork', 'Galway', 'Limerick', 'Waterford', 'Killarney', 'Drogheda', 'Sligo', 'Wexford', 'Tralee'],
        'SE' => ['Stockholm', 'Goteborg', 'Malmo', 'Uppsala', 'Linkoping', 'Helsingborg', 'Norrkoping', 'Orebro', 'Vasteras', 'Umea'],
        'NO' => ['Oslo', 'Bergen', 'Trondheim', 'Stavanger', 'Tromso', 'Kristiansand', 'Alesund', 'Drammen', 'Fredrikstad', 'Bodo'],
        'DK' => ['Copenhague', 'Aarhus', 'Odense', 'Aalborg', 'Esbjerg', 'Helsingor', 'Frederiksberg', 'Roskilde', 'Vejle', 'Horsens'],
        'FI' => ['Helsinki', 'Tampere', 'Turku', 'Espoo', 'Oulu', 'Rovaniemi', 'Lahti', 'Kuopio', 'Jyvaskyla', 'Vaasa'],
        'IS' => ['Reykjavik', 'Akureyri', 'Hafnarfjordur', 'Keflavik', 'Selfoss', 'Vik', 'Borgarnes', 'Egilsstadir', 'Husavik', 'Isafjordur'],
        'CZ' => ['Prague', 'Brno', 'Ostrava', 'Plzen', 'Cesky Krumlov', 'Karlovy Vary', 'Olomouc', 'Liberec', 'Pardubice', 'Ceske Budejovice'],
        'HU' => ['Budapest', 'Debrecen', 'Szeged', 'Pecs', 'Gyor', 'Miskolc', 'Eger', 'Sopron', 'Szombathely', 'Kecskemet'],
        'RO' => ['Bucarest', 'Cluj-Napoca', 'Brasov', 'Timisoara', 'Sibiu', 'Iasi', 'Constanta', 'Craiova', 'Galati', 'Oradea'],
        'BG' => ['Sofia', 'Plovdiv', 'Varna', 'Bourgas', 'Veliko Tarnovo', 'Bansko', 'Pleven', 'Ruse', 'Stara Zagora', 'Nessebar'],
        'EE' => ['Tallinn', 'Tartu', 'Parnu', 'Narva', 'Viljandi', 'Kuressaare', 'Rakvere', 'Haapsalu', 'Jogeva', 'Valga'],
        'LV' => ['Riga', 'Liepaja', 'Daugavpils', 'Jurmala', 'Ventspils', 'Cesis', 'Jelgava', 'Rezekne', 'Valmiera', 'Sigulda'],
        'LT' => ['Vilnius', 'Kaunas', 'Klaipeda', 'Siauliai', 'Panevezys', 'Trakai', 'Druskininkai', 'Neringa', 'Birzai', 'Palanga'],
        'SI' => ['Ljubljana', 'Maribor', 'Bled', 'Piran', 'Koper', 'Celje', 'Kranjska Gora', 'Portoroz', 'Novo Mesto', 'Murska Sobota'],
        'SK' => ['Bratislava', 'Kosice', 'Banska Bystrica', 'Zilina', 'Nitra', 'Poprad', 'Trnava', 'Presov', 'Martin', 'Ruzomberok'],
        'LU' => ['Luxembourg-Ville', 'Esch-sur-Alzette', 'Differdange', 'Dudelange', 'Ettelbruck', 'Diekirch', 'Wiltz', 'Echternach', 'Remich', 'Grevenmacher'],
        'MT' => ['La Valette', 'Sliema', 'Saint-Julien', 'Mdina', 'Gozo', 'Mellieha', 'Marsaxlokk', 'Birgu', 'Mosta', 'Rabat'],
        'CY' => ['Nicosie', 'Limassol', 'Larnaca', 'Paphos', 'Ayia Napa', 'Famagouste', 'Kyrenia', 'Protaras', 'Polis', 'Platres'],
        'RU' => ['Moscou', 'Saint-Petersbourg', 'Sotchi', 'Kazan', 'Ekaterinbourg', 'Vladivostok', 'Novossibirsk', 'Krasnodar', 'Nijni Novgorod', 'Samara'],
        'UA' => ['Kiev', 'Lviv', 'Odessa', 'Kharkiv', 'Dnipro', 'Tchernivtsi', 'Zaporijjia', 'Poltava', 'Mykolaiv', 'Vinnytsia'],

        // ── ASIE (additional hubs) ──
        'CN' => ['Pekin', 'Shanghai', 'Shenzhen', 'Guangzhou', 'Chengdu', 'Hangzhou', 'Wuhan', 'Chongqing', 'Xian', 'Suzhou'],
        'HK' => ['Central', 'Kowloon', 'Causeway Bay', 'Tsim Sha Tsui', 'Mong Kok', 'Wan Chai', 'Sha Tin', 'Tuen Mun', 'Yuen Long', 'Aberdeen'],
        'TW' => ['Taipei', 'Kaohsiung', 'Taichung', 'Tainan', 'Hsinchu', 'Hualien', 'Taoyuan', 'Keelung', 'Chiayi', 'Changhua'],
        'KR' => ['Seoul', 'Busan', 'Incheon', 'Daegu', 'Jeju', 'Gwangju', 'Daejeon', 'Suwon', 'Ulsan', 'Gangneung'],
        'IL' => ['Tel Aviv', 'Jerusalem', 'Haifa', 'Eilat', 'Netanya', 'Herzliya', 'Beer Sheva', 'Petah Tikva', 'Rishon LeZion', 'Ashdod'],
        'LB' => ['Beyrouth', 'Byblos', 'Tripoli', 'Tyr', 'Saida', 'Baalbek', 'Zahle', 'Jounieh', 'Jbeil', 'Antelias'],
        'JO' => ['Amman', 'Petra', 'Aqaba', 'Madaba', 'Jerash', 'Wadi Rum', 'Irbid', 'Zarqa', 'Ajloun', 'Kerak'],
        'SA' => ['Riyad', 'Djeddah', 'La Mecque', 'Medine', 'Dammam', 'Khobar', 'Tabuk', 'Abha', 'Taif', 'Al Ula'],
        'QA' => ['Doha', 'Al Wakrah', 'Al Khor', 'Lusail', 'Al Rayyan', 'Mesaieed', 'Al Shamal', 'Dukhan', 'Al Wakail', 'Umm Salal'],
        'BH' => ['Manama', 'Riffa', 'Muharraq', 'Hamad Town', 'Isa Town', 'Sitra', 'Jidhafs', 'Budaiya', 'Zinj', 'Aali'],
        'OM' => ['Mascate', 'Salalah', 'Sohar', 'Nizwa', 'Sur', 'Khasab', 'Ibri', 'Rustaq', 'Barka', 'Duqm'],
        'KW' => ['Koweit-Ville', 'Hawalli', 'Salmiya', 'Farwaniya', 'Mahboula', 'Ahmadi', 'Fahaheel', 'Jabriya', 'Sabah Al Salem', 'Rumaithiya'],
        'PK' => ['Karachi', 'Lahore', 'Islamabad', 'Rawalpindi', 'Peshawar', 'Faisalabad', 'Multan', 'Quetta', 'Gujranwala', 'Sialkot'],
        'BD' => ['Dacca', 'Chittagong', 'Sylhet', 'Khulna', 'Rajshahi', 'Cox\'s Bazar', 'Comilla', 'Mymensingh', 'Rangpur', 'Narayanganj'],
        'LK' => ['Colombo', 'Kandy', 'Galle', 'Negombo', 'Jaffna', 'Trincomalee', 'Ella', 'Mirissa', 'Anuradhapura', 'Sigiriya'],
        'NP' => ['Katmandou', 'Pokhara', 'Lalitpur', 'Bhaktapur', 'Chitwan', 'Lumbini', 'Nagarkot', 'Namche Bazar', 'Janakpur', 'Dharan'],
        'MM' => ['Yangon', 'Mandalay', 'Bagan', 'Naypyidaw', 'Inle Lake', 'Taunggyi', 'Mrauk U', 'Ngapali', 'Hpa-An', 'Mawlamyine'],
        'LA' => ['Vientiane', 'Luang Prabang', 'Pakse', 'Vang Vieng', 'Savannakhet', 'Champasak', 'Thakhek', 'Muang Khong', 'Nong Khiaw', 'Sam Neua'],

        // ── AMERIQUES (additional hubs) ──
        'AR' => ['Buenos Aires', 'Cordoba', 'Mendoza', 'Bariloche', 'Rosario', 'Salta', 'Ushuaia', 'Mar del Plata', 'Tucuman', 'Neuquen'],
        'CL' => ['Santiago', 'Valparaiso', 'Vina del Mar', 'Concepcion', 'La Serena', 'Pucon', 'Atacama', 'Puerto Varas', 'Arica', 'Iquique'],
        'PE' => ['Lima', 'Cusco', 'Arequipa', 'Trujillo', 'Iquitos', 'Puno', 'Huaraz', 'Paracas', 'Nazca', 'Mancora'],
        'EC' => ['Quito', 'Guayaquil', 'Cuenca', 'Banos', 'Galapagos', 'Otavalo', 'Mindo', 'Montanita', 'Quilotoa', 'Riobamba'],
        'BO' => ['La Paz', 'Santa Cruz', 'Cochabamba', 'Sucre', 'Potosi', 'Uyuni', 'Oruro', 'Copacabana', 'Samaipata', 'Rurrenabaque'],
        'PY' => ['Asuncion', 'Ciudad del Este', 'Encarnacion', 'San Lorenzo', 'Luque', 'Lambare', 'Concepcion', 'Coronel Oviedo', 'Pedro Juan Caballero', 'Villarrica'],
        'UY' => ['Montevideo', 'Punta del Este', 'Colonia del Sacramento', 'Maldonado', 'Salto', 'Paysandu', 'Rivera', 'Melo', 'Tacuarembo', 'Rocha'],
        'PA' => ['Panama City', 'Boquete', 'Bocas del Toro', 'David', 'Coronado', 'El Valle', 'Pedasi', 'Santa Fe', 'Las Tablas', 'Portobelo'],
        'GT' => ['Guatemala City', 'Antigua', 'Atitlan', 'Quetzaltenango', 'Tikal', 'Flores', 'Coban', 'Livingston', 'Chichicastenango', 'Semuc Champey'],
        'NI' => ['Managua', 'Granada', 'Leon', 'San Juan del Sur', 'Ometepe', 'Esteli', 'Masaya', 'Matagalpa', 'San Carlos', 'Little Corn Island'],
        'DO' => ['Saint-Domingue', 'Punta Cana', 'Santiago', 'Puerto Plata', 'Las Terrenas', 'Samana', 'Boca Chica', 'Cabarete', 'Constanza', 'Jarabacoa'],
        'CU' => ['La Havane', 'Varadero', 'Trinidad', 'Vinales', 'Santiago de Cuba', 'Cienfuegos', 'Camaguey', 'Holguin', 'Guardalavaca', 'Santa Clara'],
        'JM' => ['Kingston', 'Montego Bay', 'Negril', 'Ocho Rios', 'Port Antonio', 'Falmouth', 'Runaway Bay', 'Treasure Beach', 'Blue Mountains', 'Mandeville'],

        // ── AFRIQUE (additional hubs) ──
        'EG' => ['Le Caire', 'Alexandrie', 'Hurghada', 'Charm el-Cheikh', 'Louxor', 'Assouan', 'El Gouna', 'Dahab', 'Marsa Alam', 'Siwa'],
        'TN' => ['Tunis', 'Sousse', 'Hammamet', 'Djerba', 'Sfax', 'Monastir', 'Nabeul', 'Bizerte', 'Kairouan', 'Tabarka'],
        'DZ' => ['Alger', 'Oran', 'Constantine', 'Annaba', 'Tlemcen', 'Setif', 'Ghardaia', 'Tamanrasset', 'Bejaia', 'Skikda'],
        'SN' => ['Dakar', 'Saint-Louis', 'Thies', 'Ziguinchor', 'Saly', 'Mbour', 'Touba', 'Kaolack', 'Tambacounda', 'Richard-Toll'],
        'CI' => ['Abidjan', 'Yamoussoukro', 'Bouake', 'San-Pedro', 'Korhogo', 'Grand-Bassam', 'Gagnoa', 'Man', 'Divo', 'Daloa'],
        'KE' => ['Nairobi', 'Mombasa', 'Kisumu', 'Nakuru', 'Malindi', 'Lamu', 'Diani Beach', 'Eldoret', 'Nanyuki', 'Watamu'],
        'TZ' => ['Dar es Salaam', 'Zanzibar', 'Arusha', 'Mwanza', 'Dodoma', 'Kilimandjaro', 'Moshi', 'Stone Town', 'Pemba', 'Morogoro'],
        'ZA' => ['Le Cap', 'Johannesbourg', 'Durban', 'Pretoria', 'Port Elizabeth', 'Stellenbosch', 'Knysna', 'George', 'Kimberley', 'Bloemfontein'],
        'NG' => ['Lagos', 'Abuja', 'Port Harcourt', 'Kano', 'Ibadan', 'Calabar', 'Enugu', 'Benin City', 'Jos', 'Kaduna'],
        'GH' => ['Accra', 'Kumasi', 'Cape Coast', 'Tamale', 'Takoradi', 'Ho', 'Sunyani', 'Wa', 'Bolgatanga', 'Tema'],
        'CM' => ['Yaounde', 'Douala', 'Bafoussam', 'Limbe', 'Kribi', 'Garoua', 'Maroua', 'Ngaoundere', 'Ebolowa', 'Edea'],
        'MU' => ['Port Louis', 'Grand Baie', 'Flic en Flac', 'Curepipe', 'Quatre Bornes', 'Belle Mare', 'Tamarin', 'Mahebourg', 'Beau Bassin', 'Chamarel'],
        'MG' => ['Antananarivo', 'Nosy Be', 'Antsirabe', 'Tulear', 'Diego Suarez', 'Sainte Marie', 'Morondava', 'Ifaty', 'Majunga', 'Fort Dauphin'],
        'RW' => ['Kigali', 'Butare', 'Gisenyi', 'Ruhengeri', 'Cyangugu', 'Kibuye', 'Nyanza', 'Byumba', 'Rwamagana', 'Musanze'],
        'ET' => ['Addis-Abeba', 'Lalibela', 'Gondar', 'Bahir Dar', 'Axoum', 'Harar', 'Dire Dawa', 'Jimma', 'Arba Minch', 'Mekele'],

        // ── OCEANIE (additional hubs) ──
        'NZ' => ['Auckland', 'Wellington', 'Christchurch', 'Queenstown', 'Rotorua', 'Dunedin', 'Hamilton', 'Napier', 'Wanaka', 'Abel Tasman'],
        'FJ' => ['Suva', 'Nadi', 'Lautoka', 'Denarau', 'Coral Coast', 'Mamanuca', 'Yasawa', 'Levuka', 'Sigatoka', 'Pacific Harbour'],

        // ══════════════════════════════════════════════════════════════════
        // REMAINING COUNTRIES — smaller hubs and less common destinations
        // ══════════════════════════════════════════════════════════════════

        // ── EUROPE (remaining) ──
        'AL' => ['Tirana', 'Durres', 'Vlore', 'Shkoder', 'Sarande', 'Gjirokaster', 'Berat', 'Korce', 'Permet', 'Pogradec'],
        'AD' => ['Andorre-la-Vieille', 'Encamp', 'La Massana', 'Les Escaldes', 'Ordino', 'Sant Julia de Loria', 'Canillo', 'Arinsal', 'El Pas de la Casa', 'Pal'],
        'BY' => ['Minsk', 'Brest', 'Gomel', 'Moguilev', 'Grodno', 'Vitebsk', 'Borisov', 'Pinsk', 'Orsha', 'Baranovichi'],
        'BA' => ['Sarajevo', 'Banja Luka', 'Mostar', 'Tuzla', 'Zenica', 'Bihac', 'Neum', 'Trebinje', 'Jajce', 'Medjugorje'],
        'XK' => ['Pristina', 'Prizren', 'Peje', 'Gjakova', 'Mitrovica', 'Ferizaj', 'Gjilan', 'Vushtri', 'Skenderaj', 'Dragash'],
        'LI' => ['Vaduz', 'Schaan', 'Balzers', 'Triesen', 'Eschen', 'Mauren', 'Ruggell', 'Gamprin', 'Schellenberg', 'Planken'],
        'MD' => ['Chisinau', 'Balti', 'Tiraspol', 'Cahul', 'Ungheni', 'Orhei', 'Soroca', 'Straseni', 'Edinet', 'Rezina'],
        'MC' => ['Monaco-Ville', 'Monte-Carlo', 'La Condamine', 'Fontvieille', 'Larvotto', 'Moneghetti', 'Jardin Exotique', 'Port Hercule', 'Les Revoires', 'Saint-Roman'],
        'ME' => ['Podgorica', 'Niksic', 'Pljevlja', 'Bijelo Polje', 'Cetinje', 'Budva', 'Kotor', 'Herceg Novi', 'Bar', 'Ulcinj'],
        'MK' => ['Skopje', 'Bitola', 'Kumanovo', 'Prilep', 'Tetovo', 'Veles', 'Ohrid', 'Strumica', 'Gostivar', 'Kocani'],
        'SM' => ['Saint-Marin', 'Borgo Maggiore', 'Serravalle', 'Domagnano', 'Fiorentino', 'Acquaviva', 'Montegiardino', 'Faetano', 'Chiesanuova', 'Citta di San Marino'],
        'RS' => ['Belgrade', 'Novi Sad', 'Nis', 'Kragujevac', 'Subotica', 'Zemun', 'Pancevo', 'Cacak', 'Leskovac', 'Smederevo'],
        'VA' => ['Vatican', 'Place Saint-Pierre', 'Castel Gandolfo', 'Chapelle Sixtine', 'Musees du Vatican', 'Jardins du Vatican', 'Palais Apostolique', 'Basilique Saint-Pierre', 'Archives Apostoliques', 'Obelisque du Vatican'],

        // ── ASIE (remaining) ──
        'AF' => ['Kaboul', 'Herat', 'Kandahar', 'Mazar-i-Sharif', 'Jalalabad', 'Kunduz', 'Ghazni', 'Balkh', 'Khost', 'Bamyan'],
        'AM' => ['Erevan', 'Gyumri', 'Vanadzor', 'Vagharshapat', 'Abovian', 'Kapan', 'Dilijan', 'Goris', 'Sevan', 'Alaverdi'],
        'AZ' => ['Bakou', 'Gandja', 'Soumgait', 'Mingachevir', 'Qabala', 'Lankaran', 'Chirvan', 'Nakhitchevan', 'Chaki', 'Tovouz'],
        'BT' => ['Thimphou', 'Paro', 'Punakha', 'Phuentsholing', 'Jakar', 'Trongsa', 'Haa', 'Trashigang', 'Gasa', 'Bumthang'],
        'BN' => ['Bandar Seri Begawan', 'Kuala Belait', 'Seria', 'Tutong', 'Bangar', 'Muara', 'Temburong', 'Kampung Ayer', 'Jerudong', 'Lumut'],
        'GE' => ['Tbilissi', 'Batoumi', 'Koutaissi', 'Roustavi', 'Mestia', 'Gori', 'Signaghi', 'Mtskheta', 'Telavi', 'Borjomi'],
        'IR' => ['Teheran', 'Ispahan', 'Chiraz', 'Machhad', 'Tabriz', 'Qom', 'Kashan', 'Yazd', 'Ahvaz', 'Kerman'],
        'IQ' => ['Bagdad', 'Bassora', 'Erbil', 'Mossoul', 'Kerbala', 'Nadjaf', 'Sulaimaniyah', 'Dohuk', 'Kirkuk', 'Tikrit'],
        'KZ' => ['Astana', 'Almaty', 'Chimkent', 'Karaganda', 'Aktobe', 'Taraz', 'Semey', 'Pavlodar', 'Ust-Kamenogorsk', 'Aktau'],
        'KP' => ['Pyongyang', 'Hamhung', 'Chongjin', 'Nampo', 'Wonsan', 'Sinuiju', 'Kaesong', 'Sariwon', 'Kanggye', 'Hyesan'],
        'KG' => ['Bichkek', 'Och', 'Djalal-Abad', 'Tokmok', 'Karakol', 'Balychky', 'Naryn', 'Talas', 'Kara-Suu', 'Uzgen'],
        'MO' => ['Macao', 'Taipa', 'Coloane', 'Cotai', 'Sao Lourenco', 'Se', 'Monte', 'Barra', 'Iao Hon', 'Ka Ho'],
        'MV' => ['Male', 'Hulhumale', 'Addu', 'Fuvahmulah', 'Kulhudhuffushi', 'Thinadhoo', 'Maafushi', 'Baa Atoll', 'Rasdhoo', 'Thulusdhoo'],
        'MN' => ['Oulan-Bator', 'Erdenet', 'Darkhan', 'Choibalsan', 'Moron', 'Kharkhorin', 'Olgii', 'Bayankhongor', 'Mandalgovi', 'Bulgan'],
        'PS' => ['Ramallah', 'Gaza', 'Hebron', 'Naplouse', 'Bethleem', 'Jenine', 'Jericho', 'Tulkarm', 'Qalqilya', 'Khan Younis'],
        'SY' => ['Damas', 'Alep', 'Homs', 'Lattaquie', 'Hama', 'Deir ez-Zor', 'Raqqa', 'Hasaka', 'Qamishli', 'Tartous'],
        'TJ' => ['Douchanbe', 'Khujand', 'Kulyab', 'Bokhtar', 'Istravshan', 'Khorog', 'Vahdat', 'Tursunzoda', 'Isfara', 'Kulob'],
        'TL' => ['Dili', 'Baucau', 'Maliana', 'Ermera', 'Lospalos', 'Same', 'Ainaro', 'Suai', 'Viqueque', 'Gleno'],
        'TM' => ['Achgabat', 'Turkmenabat', 'Dasoguz', 'Mary', 'Balkanabat', 'Turkmenbasi', 'Tejen', 'Serdar', 'Bayramaly', 'Abadan'],
        'UZ' => ['Tachkent', 'Samarcande', 'Boukhara', 'Namangan', 'Andijan', 'Khiva', 'Fergana', 'Nukus', 'Termez', 'Gulistan'],
        'YE' => ['Sanaa', 'Aden', 'Taez', 'Al Hudaydah', 'Ibb', 'Mukalla', 'Saada', 'Sayun', 'Zinjibar', 'Marib'],

        // ── AMERIQUES (remaining) ──
        'AG' => ['Saint John', 'English Harbour', 'Jolly Harbour', 'All Saints', 'Liberta', 'Parham', 'Falmouth', 'Willoughby Bay', 'Barbuda', 'Codrington'],
        'BS' => ['Nassau', 'Freeport', 'Paradise Island', 'Bimini', 'Eleuthera', 'Exuma', 'Harbour Island', 'Andros', 'Long Island', 'Cat Island'],
        'BB' => ['Bridgetown', 'Holetown', 'Oistins', 'Speightstown', 'Bathsheba', 'Worthing', 'Crane Beach', 'Six Men', 'Paynes Bay', 'Cattlewash'],
        'BZ' => ['Belize City', 'San Pedro', 'Caye Caulker', 'Placencia', 'Hopkins', 'San Ignacio', 'Dangriga', 'Orange Walk', 'Belmopan', 'Corozal'],
        'DM' => ['Roseau', 'Portsmouth', 'Marigot', 'Castle Bruce', 'Grand Bay', 'Soufriere', 'Calibishie', 'Scotts Head', 'Kalinago', 'Rosalie'],
        'GD' => ['Saint George', 'Grenville', 'Gouyave', 'Victoria', 'Sauteurs', 'Carriacou', 'Grand Anse', 'Petite Martinique', 'Palmiste', 'Harvey Vale'],
        'GY' => ['Georgetown', 'Linden', 'New Amsterdam', 'Essequibo', 'Lethem', 'Bartica', 'Skeldon', 'Anna Regina', 'Mahdia', 'Mabaruma'],
        'HT' => ['Port-au-Prince', 'Cap-Haitien', 'Jacmel', 'Les Cayes', 'Gonaives', 'Port-de-Paix', 'Leogane', 'Petion-Ville', 'Kenscoff', 'Hinche'],
        'HN' => ['Tegucigalpa', 'San Pedro Sula', 'La Ceiba', 'Roatan', 'Utila', 'Copan', 'Tela', 'Comayagua', 'Trujillo', 'Santa Rosa de Copan'],
        'SV' => ['San Salvador', 'Santa Ana', 'San Miguel', 'Sonsonate', 'La Libertad', 'El Tunco', 'Suchitoto', 'Juayua', 'Alegria', 'El Zonte'],
        'KN' => ['Basseterre', 'Charlestown', 'Sandy Point', 'Dieppe Bay', 'Old Road', 'Newton Ground', 'Frigate Bay', 'Half Way Tree', 'Cayon', 'Tabernacle'],
        'LC' => ['Castries', 'Soufriere', 'Vieux Fort', 'Gros Islet', 'Rodney Bay', 'Marigot Bay', 'Dennery', 'Micoud', 'Canaries', 'Anse La Raye'],
        'VC' => ['Kingstown', 'Bequia', 'Mustique', 'Union Island', 'Canouan', 'Mayreau', 'Tobago Cays', 'Palm Island', 'Young Island', 'Layou'],
        'SR' => ['Paramaribo', 'Lelydorp', 'Nieuw Nickerie', 'Moengo', 'Brokopondo', 'Albina', 'Apoera', 'Groningen', 'Wageningen', 'Brownsweg'],
        'TT' => ['Port-d\'Espagne', 'San Fernando', 'Chaguanas', 'Arima', 'Scarborough', 'Crown Point', 'Point Fortin', 'La Brea', 'Speyside', 'Charlotteville'],
        'VE' => ['Caracas', 'Maracaibo', 'Valencia', 'Maracay', 'Barquisimeto', 'Merida', 'Ciudad Guayana', 'San Cristobal', 'Maturin', 'Barinas'],

        // ── AFRIQUE (remaining) ──
        'AO' => ['Luanda', 'Huambo', 'Benguela', 'Lobito', 'Lubango', 'Namibe', 'Malanje', 'Cabinda', 'Soyo', 'Uige'],
        'BJ' => ['Porto-Novo', 'Cotonou', 'Parakou', 'Djougou', 'Abomey', 'Natitingou', 'Ouidah', 'Lokossa', 'Bohicon', 'Kandi'],
        'BW' => ['Gaborone', 'Francistown', 'Molepolole', 'Maun', 'Kasane', 'Serowe', 'Palapye', 'Lobatse', 'Kanye', 'Jwaneng'],
        'BF' => ['Ouagadougou', 'Bobo-Dioulasso', 'Koudougou', 'Ouahigouya', 'Banfora', 'Kaya', 'Dedougou', 'Gaoua', 'Fada N\'Gourma', 'Zinare'],
        'BI' => ['Gitega', 'Bujumbura', 'Muyinga', 'Ruyigi', 'Ngozi', 'Rumonge', 'Bururi', 'Kayanza', 'Makamba', 'Cibitoke'],
        'CV' => ['Praia', 'Mindelo', 'Santa Maria', 'Tarrafal', 'Assomada', 'Espargos', 'Sal Rei', 'Porto Novo', 'Pedra Badejo', 'Ribeira Grande'],
        'CF' => ['Bangui', 'Bimbo', 'Berberati', 'Carnot', 'Bambari', 'Bouar', 'Mbaiki', 'Bossangoa', 'Nola', 'Bangassou'],
        'TD' => ['N\'Djamena', 'Moundou', 'Sarh', 'Abeche', 'Kelo', 'Koumra', 'Bongor', 'Doba', 'Mongo', 'Am Timan'],
        'KM' => ['Moroni', 'Moutsamoudou', 'Fomboni', 'Domoni', 'Tsembehou', 'Ouani', 'Koni', 'Mramani', 'Marahare', 'Bandamadji'],
        'CD' => ['Kinshasa', 'Lubumbashi', 'Mbuji-Mayi', 'Kisangani', 'Bukavu', 'Goma', 'Matadi', 'Kananga', 'Kolwezi', 'Likasi'],
        'CG' => ['Brazzaville', 'Pointe-Noire', 'Dolisie', 'Nkayi', 'Owando', 'Ouesso', 'Loubomo', 'Sibiti', 'Mossendjo', 'Impfondo'],
        'DJ' => ['Djibouti-Ville', 'Ali Sabieh', 'Dikhil', 'Tadjoura', 'Obock', 'Arta', 'Loyada', 'Holhol', 'Ali-Addeh', 'Damerjog'],
        'GQ' => ['Malabo', 'Bata', 'Ebebiyin', 'Luba', 'Evinayong', 'Mongomo', 'Moka', 'Riaba', 'Ureka', 'Rebola'],
        'ER' => ['Asmara', 'Keren', 'Massawa', 'Assab', 'Mendefera', 'Barentu', 'Teseney', 'Ghinda', 'Adi Quala', 'Debarwa'],
        'SZ' => ['Mbabane', 'Manzini', 'Lobamba', 'Nhlangano', 'Siteki', 'Piggs Peak', 'Mhlambanyatsi', 'Hlane', 'Matsapha', 'Big Bend'],
        'GA' => ['Libreville', 'Port-Gentil', 'Franceville', 'Oyem', 'Lambarene', 'Mouila', 'Tchibanga', 'Makokou', 'Booue', 'Koula-Moutou'],
        'GM' => ['Banjul', 'Serekunda', 'Brikama', 'Bakau', 'Farafenni', 'Basse', 'Janjanbureh', 'Mansa Konko', 'Brikama Ba', 'Soma'],
        'GN' => ['Conakry', 'Kankan', 'Nzerekore', 'Labe', 'Kindia', 'Mamou', 'Faranah', 'Siguiri', 'Gueckedou', 'Boke'],
        'GW' => ['Bissau', 'Bafata', 'Gabu', 'Canchungo', 'Bissora', 'Catio', 'Mansoa', 'Buba', 'Bubaque', 'Quebo'],
        'LS' => ['Maseru', 'Teyateyaneng', 'Mafeteng', 'Hlotse', 'Mohale\'s Hoek', 'Qacha\'s Nek', 'Butha-Buthe', 'Mokhotlong', 'Thaba-Tseka', 'Quthing'],
        'LR' => ['Monrovia', 'Gbarnga', 'Kakata', 'Harper', 'Ganta', 'Buchanan', 'Zwedru', 'Voinjama', 'Tubmanburg', 'Greenville'],
        'LY' => ['Tripoli', 'Benghazi', 'Misrata', 'Tobrouk', 'Sirte', 'Sabha', 'Derna', 'Al Bayda', 'Zawiya', 'Zliten'],
        'MW' => ['Lilongwe', 'Blantyre', 'Mzuzu', 'Zomba', 'Kasungu', 'Mangochi', 'Salima', 'Dedza', 'Karonga', 'Nkhotakota'],
        'ML' => ['Bamako', 'Sikasso', 'Mopti', 'Segou', 'Kayes', 'Koutiala', 'Gao', 'Tombouctou', 'Kidal', 'San'],
        'MR' => ['Nouakchott', 'Nouadhibou', 'Kiffa', 'Rosso', 'Kaedi', 'Atar', 'Tidjikja', 'Nema', 'Akjoujt', 'Zouerate'],
        'MZ' => ['Maputo', 'Beira', 'Nampula', 'Quelimane', 'Tete', 'Pemba', 'Lichinga', 'Chimoio', 'Xai-Xai', 'Inhambane'],
        'NA' => ['Windhoek', 'Walvis Bay', 'Swakopmund', 'Oshakati', 'Rundu', 'Luderitz', 'Katima Mulilo', 'Grootfontein', 'Ondangwa', 'Otjiwarongo'],
        'NE' => ['Niamey', 'Zinder', 'Maradi', 'Tahoua', 'Agadez', 'Arlit', 'Diffa', 'Dosso', 'Tillabery', 'Birni N\'Konni'],
        'SC' => ['Victoria', 'Beau Vallon', 'Praslin', 'La Digue', 'Anse Royale', 'Bel Ombre', 'Anse aux Pins', 'Cascade', 'Baie Lazare', 'Grand Anse Mahe'],
        'SL' => ['Freetown', 'Bo', 'Kenema', 'Makeni', 'Koidu', 'Port Loko', 'Bonthe', 'Magburaka', 'Kabala', 'Lunsar'],
        'SO' => ['Mogadiscio', 'Hargeisa', 'Kismayo', 'Baidoa', 'Garoowe', 'Burao', 'Bosaso', 'Berbera', 'Merca', 'Jowhar'],
        'SS' => ['Juba', 'Malakal', 'Wau', 'Yei', 'Bor', 'Bentiu', 'Torit', 'Rumbek', 'Aweil', 'Nimule'],
        'SD' => ['Khartoum', 'Omdourman', 'Port-Soudan', 'Kassala', 'Nyala', 'Wad Madani', 'El Obeid', 'Al Qadarif', 'Kosti', 'Atbara'],
        'ST' => ['Sao Tome', 'Neves', 'Santana', 'Trindade', 'Santo Amaro', 'Guadalupe', 'Sao Joao dos Angolares', 'Ribeira Afonso', 'Agua Grande', 'Lobata'],
        'TG' => ['Lome', 'Sokode', 'Kara', 'Palime', 'Atakpame', 'Bassar', 'Tsevie', 'Aneho', 'Notse', 'Dapaong'],
        'UG' => ['Kampala', 'Gulu', 'Lira', 'Mbale', 'Mbarara', 'Jinja', 'Entebbe', 'Arua', 'Kasese', 'Soroti'],
        'ZM' => ['Lusaka', 'Kitwe', 'Ndola', 'Livingstone', 'Kabwe', 'Chingola', 'Luanshya', 'Chipata', 'Solwezi', 'Kasama'],
        'ZW' => ['Harare', 'Bulawayo', 'Chitungwiza', 'Mutare', 'Gweru', 'Victoria Falls', 'Masvingo', 'Kwekwe', 'Kadoma', 'Hwange'],

        // ── OCEANIE (remaining) ──
        'KI' => ['Tarawa', 'Betio', 'Bairiki', 'Bikenibeu', 'Butaritari', 'Kiritimati', 'Kuria', 'Aranuka', 'Makin', 'Marakei'],
        'MH' => ['Majuro', 'Ebeye', 'Delap-Uliga-Darrit', 'Kwajalein', 'Jabor', 'Rita', 'Arno', 'Mili', 'Jaluit', 'Ailinglaplap'],
        'FM' => ['Palikir', 'Weno', 'Kolonia', 'Tofol', 'Lelu', 'Colonia', 'Nett', 'Sokehs', 'Tol', 'Polle'],
        'NR' => ['Yaren', 'Baiti', 'Anabar', 'Ewa', 'Buada', 'Meneng', 'Nibok', 'Boe', 'Uaboe', 'Ijuw'],
        'PW' => ['Ngerulmud', 'Koror', 'Melekeok', 'Airai', 'Ngchesar', 'Ngiwal', 'Ngardmau', 'Peleliu', 'Angaur', 'Kayangel'],
        'PG' => ['Port Moresby', 'Lae', 'Mount Hagen', 'Madang', 'Wewak', 'Goroka', 'Kokopo', 'Kimbe', 'Lihir', 'Popondetta'],
        'WS' => ['Apia', 'Vaitele', 'Afega', 'Savai\'i', 'Saleimoa', 'Leulumoega', 'Faleasiu', 'Faleolo', 'Manono', 'Mulifanua'],
        'SB' => ['Honiara', 'Auki', 'Gizo', 'Munda', 'Buala', 'Tulagi', 'Kirakira', 'Lata', 'Taro', 'Tigoa'],
        'TO' => ['Nuku\'alofa', 'Neiafu', 'Ha\'apai', 'Eua', 'Vava\'u', 'Niuatoputapu', 'Pangai', 'Ohonua', 'Kolonga', 'Lapaha'],
        'TV' => ['Funafuti', 'Savave', 'Tumaseu', 'Asau', 'Kulia', 'Tanrake', 'Alapi', 'Senala', 'Tepuka', 'Funafara'],
        'VU' => ['Port-Vila', 'Luganville', 'Lakatoro', 'Norsup', 'Sola', 'Lenakel', 'Isangel', 'Longana', 'Craig Cove', 'Lamap'],
    ];
    ...
    public function getContentPlan(string $countryCode, string $countryName): array
    {
        ...
        return [
            ...
            ['type' => 'article', 'intent' => 'informational', 'topic' => "Convention fiscale avec {$countryName} : eviter la double imposition selon votre pays d'origine ({$year})"],
            ...
            ['type' => 'article', 'intent' => 'informational', 'topic' => "Equivalences de diplomes {$en} : faire reconnaitre un cursus etranger ({$year})"],
            ...
            ['type' => 'brand_content', 'intent' => 'commercial_investigation', 'topic' => "Diplome etranger non reconnu {$en} : la solution SOS-Expat.com pour faire valoir vos droits ({$year})"],
