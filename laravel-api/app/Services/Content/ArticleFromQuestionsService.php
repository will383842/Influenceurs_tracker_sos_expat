    ...
    public function generateFromCluster(QuestionCluster $cluster): GeneratedArticle
    {
        ...
        try {
            ...
            $article = GeneratedArticle::create([
                ...
                'excerpt' => \App\Support\SmartTruncate::run($parsed['excerpt'] ?? '', 500),
                'meta_title' => \App\Support\SmartTruncate::run($parsed['meta_title'] ?? $title, 60),
                'meta_description' => \App\Support\SmartTruncate::run($parsed['meta_description'] ?? '', 160),
