...
class ContentTypeConfig
{
    ...
    private const TITLE_INSTRUCTION = "\n\nTITRE : NE JAMAIS utiliser « Guide Complet », « Guide Ultime », « Tout savoir sur », « Découvrez ». "
        ...
        . "MULTI-NATIONALITE (CRITIQUE — VIOLATION = ARTICLE REJETE) :\n"
        . "- Le contenu s'adresse a TOUTE personne de TOUTE nationalite, PAS uniquement les Francais.\n"
        . "- Dire 'votre ambassade' ou 'l'ambassade de votre pays', JAMAIS 'l'ambassade de France'.\n"
        . "- Utiliser des prenoms internationaux varies (Aisha, Carlos, Priya, Kenji, Fatima, Olga, Wei, Dmitri...), PAS uniquement des prenoms francais.\n"
        . "- Formuler les conseils universellement : 'verifiez aupres de votre consulat' (pas 'le consulat de France').\n"
        . "- INTERDIT ABSOLU — NE JAMAIS MENTIONNER ces organismes specifiques a la France :\n"
        . "  * CFE (Caisse des Francais de l'Etranger)\n"
        . "  * CPAM, securite sociale francaise, mutuelle francaise\n"
        . "  * impots en France, administration fiscale francaise\n"
        . "  * systeme francais, droit francais (sauf si l'article concerne la France)\n"
        . "  * Pole Emploi, CAF, RSA, APL\n"
        . "  A la place dire : 'le systeme de securite sociale de votre pays d'origine', 'votre caisse d'assurance maladie nationale', 'l'administration fiscale de votre pays'.\n"
        . "- Le lecteur peut etre Allemand, Espagnol, Bresilien, Indien, Japonais — PAS SEULEMENT Francais.\n"
        . "- L'article est ecrit en francais car c'est une langue internationale, PAS parce que le public est francais.\n\n"
        ...
        . "- Utilise des ANECDOTES CONCRETES avec des prenoms internationaux varies (ex: 'Priya, 34 ans, arrivee a Lisbonne en janvier, a decouvert que...' ou 'Carlos, ingenieur bresilien installe a Berlin...').\n"
